...
const COLUMNS: Column<OrderItemRow>[] = [
  ...
  { header: '주문수량', align: 'right', render: (i) => i.orderedQty },
  { header: '피킹수량', align: 'right', render: (i) => i.pickedQty },
  { header: '상차수량', align: 'right', render: (i) => i.loadedQty },
  { header: '배송수량', align: 'right', render: (i) => i.deliveredQty },
];
